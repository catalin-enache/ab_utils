            ...
            <div>
                ...
                <div className="sliders clearfix">
                    ...
                    <div className="verticalSliders clearfix">
                        ...
                        <div className="verticalSliderWrapper">
                            <Slider name="slider_4"  value={this.state.sliderValue} start={-2} end={2} onChange={this.sliderOnChange} orientation="vertical" style={{height: '75%', bgColor: '#003366', width: '8px', border: '1px solid black', boxSizing: 'border-box', opacity: '.5'}}  />
                        </div>
                    </div>
                </div>
