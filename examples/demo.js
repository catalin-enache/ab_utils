                ...
                <div className="sliders clearfix">
                    <div className="horizontalSliders">
                        <div className="horizontalSliderWrapper">
                            <Slider name="slider_1" defaultValue={this.state.sliderValue} start={-2} end={2} onChange={this.sliderOnChange} style={{}} />
                        </div>
                        <div className="horizontalSliderWrapper">
                            <Slider name="slider_2" value={this.state.sliderValue} start={-2} end={2} onChange={this.sliderOnChange} style={{width: '100%', bgColor: '#003366'}} debug={false} />
                        </div>
                    </div>
                    <div className="verticalSliders clearfix">
                        <div className="verticalSliderWrapper">
                            <Slider name="slider_3"  defaultValue={this.state.sliderValue} start={-2} end={2} step={1} onChange={this.sliderOnChange} orientation="vertical" style={{height: '100%'}} />
                        </div>
                        <div className="verticalSliderWrapper">
                            <Slider name="slider_4"  value={this.state.sliderValue} start={-2} end={2} step={1} disabled={true} onChange={this.sliderOnChange} orientation="vertical" style={{height: '75%', bgColor: '#003366', width: '8px', border: '1px solid black', boxSizing: 'border-box'}} debug={false} />
                        </div>
                    </div>
                </div>
            </div>
